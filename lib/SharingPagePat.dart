...
class SharingPagePat extends StatefulWidget {
  String filename;
  String filetype;
  String phone;
  String note;
  ...
  SharingPagePat(
      ...
      this.userType});
  @override
  _SharingPagePatState createState() => _SharingPagePatState();
}

class _SharingPagePatState extends State<SharingPagePat> {
